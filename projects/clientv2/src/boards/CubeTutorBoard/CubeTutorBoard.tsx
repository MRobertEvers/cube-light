...
import { DECK_BOARD_LABELS, DECK_BOARD_ORDER } from '../../utils/deck-boards';
import {
	type CubeTutorColumn,
	groupCubeTutorCards
} from '../../utils/group-cube-tutor-cards';
import { type DeckCardGroup, manaValue } from '../../utils/group-deck-cards';
...
type Preview = { card: FetchAPIDeckCardResponse; row: DOMRect };

function allCards(deck: DeckMappedData): FetchAPIDeckCardResponse[] {
