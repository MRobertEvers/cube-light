...
import { syncHostKind } from '../../torimtg';
...
export function OfflineStatus() {
    ...
    return <details className={styles.status}>
        ...
        <div className={styles.panel}>
            ...
            {syncHostKind() === 'window' && <p>The offline worker could not start on this origin, so edits sync only while this tab is open and the app will not load while offline. Open the app over HTTPS with a trusted certificate, or on localhost, for the full offline behaviour.</p>}
