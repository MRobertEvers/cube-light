...
test('saves offline, reloads with no network, and syncs the edit with bearer auth', { timeout: 120000 }, async () => {
    ...
    try {
        ...
        // The shell worker must control the page before the network goes, or a reload cannot load.
