...
const { targets } = JSON.parse(fs.readFileSync(path.join(root, 'binding.gyp'), 'utf8'));
...
fs.writeFileSync(path.join(root, 'compile_commands.json'), JSON.stringify(commands, null, 2) + '\n');
