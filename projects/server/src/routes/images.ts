...
import { CardImageService, isImageVariant, isScryfallId } from '../images/card-images';

export function createRoutesImages(images: CardImageService): Router {
	const app = Router();

	app.get('/images/:variant/:id.jpg', async (req: Request<{ variant: string; id: string }>, res: Response) => {
